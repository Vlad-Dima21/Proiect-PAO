...
public class CofetarieRepository implements GenericRepository<Cofetarie> {
    ...
    private static List<Cofetarie> listaCofetarii = Arrays.asList(new Cofetarie(new Locatie("Bacău", "Onesti", null, "Emil Rebreanu", "7", false), 7, 16, 20),
    ...
    public Cofetarie get(int id) {
        for (Cofetarie cofetarie : listaCofetarii) {
            if (cofetarie.getIdCofetarie() == id) {
                return cofetarie;
            }
        }
        return null;
